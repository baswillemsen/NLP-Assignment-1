...
# POStags = []
# for token in doc:
#     if not token.is_punct:            # Y/N punctuation?
...
#
# print(df[df['POStags'] == 'NN']['POStoken'].value_counts())
# print(df[df['POStags'] == 'NNP']['POStoken'].value_counts())
# print(df[df['POStags'] == 'IN']['POStoken'].value_counts())
# print(df[df['POStags'] == 'DT']['POStoken'].value_counts())
# print(df[df['POStags'] == 'JJ']['POStoken'].value_counts())
# print(df[df['POStags'] == 'NNS']['POStoken'].value_counts())
# print(df[df['POStags'] == 'VBD']['POStoken'].value_counts())
# print(df[df['POStags'] == '_SP']['POStoken'].value_counts())
# print(df[df['POStags'] == 'VBN']['POStoken'].value_counts())
# print(df[df['POStags'] == 'RB']['POStoken'].value_counts())
